            ...
            <div class="proekt-inner">
                ...
                <h1>Завод им.Медведева</h1>
                    <div class="proekt-tech">
                        Кран опорный однобалочный грузоподъёмность 5 тонн<br>Срок изготовления 30 рабочих дней
                    </div>
                </div>
            
            <div class="proekt-gallery">
                <picture>
                    <source srcset="/files/proekt/orel-medvd/02.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/orel-medvd/02.avif" alt="" />
                </picture>
            </div>
