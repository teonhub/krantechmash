<script setup lang="ts">
    ...
    useHead({
        ...
        title: 'Проект: военно-промышленной комплекс - кран опорный двухбалочный',
        meta:
            [
    ...
    <main>
        <div class="proekt-wrap">
            <div class="proekt-inner">
                ...
                <h1>Военно-промышленный комплекс</h1>
                <div class="proekt-tech">
                    Кран опорный двухбалочный: грузоподъёмность 20 тонн<br>Срок изготовления: 35 рабочих дней
                </div>
            </div>
            <div class="proekt-gallery">
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/02.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/02.avif" alt="" />
                </picture>
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/03.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/03.avif" alt="" />
                </picture>
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/04.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/04.avif" alt="" />
                </picture>
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/05.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/05.avif" alt="" />
                </picture>
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/06.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/06.avif" alt="" />
                </picture>
                <picture>
                    <source srcset="/files/proekt/kolomna-vpk/07.avif" media="(min-width: 600px)" />
                    <img src="/files/proekt/kolomna-vpk/07.avif" alt="" />
                </picture>
                <div class="link-back">
